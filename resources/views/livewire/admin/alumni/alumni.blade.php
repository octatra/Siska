        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <a href="{{ route('admin.alumni.create') }}" class="btn btn-sm btn-primary ms-3">
                        <i data-feather="plus-circle"></i> Tambah Mahasiswa Alumni
                    </a>
                </div>
