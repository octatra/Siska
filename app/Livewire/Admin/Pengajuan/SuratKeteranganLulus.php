...
class SuratKeteranganLulus extends Component
{
    ...
    public function render()
    {
        $data = Pengajuan::where('status', 'Menunggu')
            ->where('jenis_pengajuan', 'Surat Keterangan Lulus')
            ->paginate(10);

        return view('livewire.admin.pengajuan.surat-keterangan-lulus', ['data' => $data]);
    }
}
