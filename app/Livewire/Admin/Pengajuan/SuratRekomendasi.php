...
class SuratRekomendasi extends Component
{
    ...
    public function render()
    {
        $data = Pengajuan::where('status', 'Menunggu')
            ->where('jenis_pengajuan', 'Surat Rekomendasi Jurusan')
            ->paginate(10);

        return view('livewire.admin.pengajuan.surat-rekomendasi', ['data' => $data]);
    }
}
